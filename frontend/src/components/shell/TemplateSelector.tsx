  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 16, padding: 32 }}>
      ...
      <button
        ...
        onClick={() => onGenerate({ id: 'react-fastapi', name: 'React + FastAPI', icon: '⚡', badge: 'POPULAR', description: '', ibmBindings: [] }, 'Demo prompt')}
      >
...
export const TEMPLATES = [
  { id: 'react-fastapi', name: 'React + FastAPI', icon: '⚡', badge: 'POPULAR', description: 'Full-stack with IBM Cloud', ibmBindings: ['IBM Code Engine', 'Supabase', 'Cloudflare'] },
]
